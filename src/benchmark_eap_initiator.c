/*
 * =============================================================================
 * EDHOC-Hybrid: EAP-EDHOC Benchmark — Initiator (EAP Peer)
 * =============================================================================
 *
 * Connects to the EAP-EDHOC Responder (EAP Server) via TCP.
 * Executes all 5 EDHOC variants wrapped in EAP-EDHOC framing.
...
int main(int argc, char *argv[])
{
	...
	int port = (argc > 2) ? atoi(argv[2]) : EAP_DEFAULT_PORT;
	...
	printf("\n");
	printf("╔══════════════════════════════════════════════════════════════╗\n");
	printf("║      EDHOC EAP-EDHOC Benchmark — INITIATOR (EAP Peer)        ║\n");
	printf("╚══════════════════════════════════════════════════════════════╝\n");
	printf("  Server: %s:%d\n", server_ip, port);
	...
	printf("\n═══ Phase 2: Full Handshake Benchmarks (EAP-EDHOC) ═══\n\n");
	...
	printf("  Connected to EAP-EDHOC server.\n\n");
...
/* =============================================================================
 * Phase 2: Run all EAP-EDHOC handshake variants
 * =============================================================================
 */
static void run_handshake_benchmarks(int sockfd)
{
	...
	for (int i = 0; i < 5; i++) {
		printf("  [%d/5] %s (EAP Peer/Initiator)...\n", i + 1, variants[i].name);
